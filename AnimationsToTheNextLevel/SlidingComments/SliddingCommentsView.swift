...
class SliddingCommentsView: UIViewController {
    ...
    init() {
        super.init(nibName: String(describing: SliddingCommentsView.self), bundle: nil)
    }
    ...
    func animateIfNeeded(to state: State, duration: TimeInterval) {
        ...
        basicAnimator.addAnimations {
            ...
            case .closed:
                self.commentsBottomConstraint.constant = -20
